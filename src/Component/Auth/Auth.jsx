        ...
        <div className="form-container">
          <div className="form">
            <form onSubmit={SignUpFunc}>
              <span>
                <strong className="i"> Display Name</strong>
              </span>
              <Input name="Name" typ="text" func={InputHandler} />
              <br />
              <span>
                <strong className="i">Email</strong>
              </span>
              <Input name="Email" typ="Email" func={InputHandler} /> <br />
              <span>
                <strong className="i">Password</strong>
              </span>
              ...
              <Button val="SignUp" typ="submit" styl={SubmitBtn} />
            </form>
            <p>
              <i>
        ...
        <div className="form-container">
          <div className="form">
            <form onSubmit={LoginFunc}>
              ...
              <Button val="Login" typ="submit" styl={SubmitBtn} func={LoginFunc} />
            </form>
            <p>
              <i>
